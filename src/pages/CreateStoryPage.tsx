...
export const CreateStoryPage: React.FC = () => {
  ...
  const handleRewrite = async () => {
    ...
    if (age === null) {
      setErrorMessage(
        "Unable to detect age from prompt. Please include age 1-10 in your prompt.",
      );
      return;
    }
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Unable to rewrite story.";
      setErrorMessage(message);
    } finally {
        ...
        <KiddoCard hoverEffect={false} sx={{ p: 4 }}>
          <Stack spacing={2.5}>
            ...
            <Typography variant="body2" color="text.secondary">
              Chatbot-style sample generation. Include child name and age
              (1-10), for example: "Tell a bedtime story for Emma, age 7, about
              space adventure."
            </Typography>
